    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow-sm border p-5">
          <p className="text-sm text-gray-500">Saldo Pindahan</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-white rounded-lg shadow-sm border p-5">
          <p className="text-sm text-gray-500">Rata-rata Kehadiran Ibadah</p>
          <p className="text-3xl font-bold text-gray-800 mt-1">{data.avgAttendance}</p>
          <p className="text-xs text-gray-400 mt-1">orang per minggu</p>
        </div>
        <div className="bg-white rounded-lg shadow-sm border p-5">
          <p className="text-sm text-gray-500">Total Persembahan Bulan Ini</p>
          <p className="text-3xl font-bold text-gray-800 mt-1">
            {formatRupiah(data.totalPersembahan)}
          </p>
          <p className="text-xs text-gray-400 mt-1">kantong ungu + hitam + sekolah minggu</p>
        </div>
      </div>
          ...
          {data.trend.map((t) => (
            <div key={`${t.year}-${t.month}`} className="space-y-1">
              ...
              <div className="flex gap-1">
                <div
                  className="h-4 bg-green-400 rounded-sm transition-all"
